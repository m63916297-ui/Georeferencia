...
def page_login():
    ...
    with col2:
        ...
        <div style="text-align: center;">
            ...
            <h1 style="color: #1565C0; margin: 10px 0;">SAFE</h1>
            <h3 style="color: #666; font-weight: normal;">Motor de Predicción de Eventos</h3>
        </div>
        """,
            unsafe_allow_html=True,
        )
...
def page_registro():
    ...
    with col2:
        ...
        <div style="text-align: center;">
            <h1 style="font-size: 64px; margin: 0;">🛡️</h1>
            <h1 style="color: #1565C0; margin: 10px 0;">SAFE</h1>
            <h3 style="color: #666; font-weight: normal;">Registro de Usuario</h3>
        </div>
        """,
            unsafe_allow_html=True,
        )
